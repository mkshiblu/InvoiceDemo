...
namespace InvoiceDemo
{
    public class InvoiceItemController : Controller
    {
        ...
        {
            var invoiceitems = db.InvoiceItems.Include(i => i.Invoice).Include(i => i.Product).ToList();
        ...
        public ActionResult Create([Bind(Include="ID,ProductID,InvoiceID,Quantity,Taxable,Total")] InvoiceItem invoiceitem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="ID,ProductID,InvoiceID,Quantity,Taxable,Total")] InvoiceItem invoiceitem)
        {
            if (ModelState.IsValid)
            {
